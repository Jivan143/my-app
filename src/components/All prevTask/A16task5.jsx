...
class A16Task5 extends Component{
...
state={
  ...
  handleSubmit = () => {
    ...
    render(){
        ...
        <input type="radio" className="form-check-input" name="working"   checked={working} onChange={this.handleCheckboxChange}/>
        ...
        <div className="form-check">
        <input type="radio" className="form-check-input" name="studying"   checked={studying} onChange={this.handleCheckboxChange}/>
