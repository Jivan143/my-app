...
class OptionsCBDB extends Component{
...
render (){
    const {designation="",department="",gender=""}=this.props.options;
    let {designations,departments,genders}=this.props;
    ...
    return (
        <div className="row  m-1">
            <div className="">
            {this.makeRadios(departments,department.split(","),"department"," Department")}
            </div>
           
            <div className="">
                {this.makeRadios(designations,designation.split(","),"designation","Designation")}
            </div>
            <div className="">
